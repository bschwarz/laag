...
smithy.addShape('example.users#UserService', {
  ...
  version: '2023-01-01',
  operations: [
    { target: 'example.users#GetUser' },
    { target: 'example.users#CreateUser' }
  ]
});
...
smithy.addTrait('example.users#GetUser', 'smithy.api#documentation', 
...
Check out the [examples directory](_media/examples) for more comprehensive examples:

- [Basic Usage](_media/basic-usage.ts) - Fundamental operations
- [Code Generation](_media/code-generation.ts) - Generate client code
- [Trait Usage](_media/trait-usage.ts) - Working with traits
- [Validation](_media/validation.ts) - Model validation examples
...
- [@laag/core](_media/core) - Core utilities and base classes
- [@laag/openapi](_media/openapi) - OpenAPI/Swagger document support
- [@laag/raml](_media/raml) - RAML document support
- [@laag/cli](_media/cli) - Command-line interface
...
MIT - see [LICENSE](_media/LICENSE) for details.

## Changelog

See [CHANGELOG.md](_media/CHANGELOG.md) for release history.
