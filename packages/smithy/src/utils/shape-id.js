 ...
 * ```
 */
export function parseShapeId(shapeId) {
 ...
 * ```
 */
export function isAbsoluteShapeId(shapeId) {
 ...
 * ```
 */
export function isRelativeShapeId(shapeId) {
    return !shapeId.includes('#');
}
/**
 ...
 * ```
 */
export function getNamespace(shapeId) {
 ...
 * ```
 */
export function getName(shapeId) {
 ...
 * ```
 */
export function createShapeId(namespace, name) {
 ...
 * ```
 */
export function toAbsoluteShapeId(shapeId, defaultNamespace) {
 ...
 * ```
 */
export function equalsShapeId(a, b) {
    return a === b;
}
/**
 ...
 * ```
 */
export function equalsShapeIdWithNamespace(a, b, defaultNamespace) {
 ...
 * ```
 */
export function matchesNamespace(shapeId, namespace) {
    const parsed = parseShapeId(shapeId);
 ...
 * ```
 */
export function extractNamespaces(shapeIds) {
 ...
 * ```
 */
export function filterByNamespace(shapeIds, namespace) {
 ...
 * ```
 */
export function sortShapeIds(shapeIds) {
...
//# sourceMappingURL=shape-id.js.map