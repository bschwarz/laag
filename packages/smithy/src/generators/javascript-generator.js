...
export class JavaScriptGenerator {
     ...
     */
    generateClass(shapeId, shape, _allShapes) {
        const lines = [];
     ...
     */
    generateOperationMethod(operationId, operation, _allShapes) {
        const lines = [];
        ...
        if (this.includeComments) {
            ...
            lines.push(`${this.spaces(1)} * @returns {Promise<Object>} Promise resolving to operation output`);
            lines.push(`${this.spaces(1)} */`);
        }
        // Method signature
