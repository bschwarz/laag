...
export class PythonGenerator {
     ...
     */
    generateClass(shapeId, shape, allShapes) {
        const lines = [];
     ...
     */
    generateClient(serviceId, service, allShapes) {
        const lines = [];
     ...
     */
    generateOperationMethod(operationId, operation, allShapes) {
        const lines = [];
        ...
        if (httpTrait) {
            ...
            if (operation.input && method !== 'GET') {
                ...
                lines.push(`${this.spaces(3)}json=input.__dict__ if hasattr(input, '__dict__') else input,`);
     ...
     */
    getPythonType(shapeId, allShapes) {
