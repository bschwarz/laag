...
// ============================================================================
// Base trait classes
export { ArrayTrait, BaseTrait, MarkerTrait, NumberTrait, ObjectTrait, ShapeReferenceTrait, StringTrait, } from './traits/base-trait.js';
// HTTP trait classes
export { CorsTrait, HttpErrorTrait, HttpHeaderTrait, HttpLabelTrait, HttpPayloadTrait, HttpQueryTrait, HttpResponseCodeTrait, HttpTrait, } from './traits/http-traits.js';
// AWS trait classes
export { AwsApiGatewayIntegrationTrait, AwsArnReferenceTrait, AwsArnTemplateTrait, AwsAuthTrait, AwsClientDiscoveredEndpointTrait, AwsClientEndpointDiscoveryTrait, AwsCloudFormationNameTrait, AwsControlPlaneTrait, AwsDataPlaneTrait, AwsIamActionTrait, AwsIamResourceTrait, AwsProtocolTrait, AwsSdkServiceIdTrait, } from './traits/aws-traits.js';
// ============================================================================
// Validators
// ============================================================================
/**
 ...
 * ```
 */
export { createSelectorQuery, isValidSelector, matchSelector, parseSelector, selectByNamespace, selectByTrait, selectByType, selectShapes, } from './utils/selector.js';
// ============================================================================
// Type Definitions
// ============================================================================
/**
