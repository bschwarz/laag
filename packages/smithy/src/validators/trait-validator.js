...
export class TraitValidator {
     ...
     * @returns Validation result
     */
    validateDocumentationTrait(value) {
        const errors = [];
        if (typeof value !== 'string') {
            errors.push({
    ...
    validatePaginatedTrait(value) {
        ...
        const stringFields = ['inputToken', 'outputToken', 'items', 'pageSize'];
     ...
     * @returns Validation result
     */
    checkJsonSerializable(value, path = 'trait') {
        const errors = [];
        // Reject functions
...
//# sourceMappingURL=trait-validator.js.map