...
export class ResourceShape extends BaseShape {
     ...
     */
    constructor(identifiers, properties, traits) {
     ...
     */
    setLifecycleOperation(operation, operationId) {
     ...
     */
    getLifecycleOperation(operation) {
     ...
     * @param operationId - The operation shape ID
     */
    addCollectionOperation(operationId) {
        this.collectionOperations ?? (this.collectionOperations = []);
     ...
     * @returns True if the operation was removed, false if it didn't exist
     */
    removeCollectionOperation(operationId) {
